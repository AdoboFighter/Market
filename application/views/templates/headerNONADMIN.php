      ...
      <ul class="list-unstyled components text-dark">
        ...
        <li class="">
          ...
          <ul class="collapse list-unstyled" id="homeSubmenu4">
            ...
            <li>
              <a href="<?php echo base_url() . 'pages/view/tenantinfoNONADMIN' ?>">Tenant</a>
            </li>

            <li>
              <a href="<?php echo base_url() . 'pages/view/ambuinfoNONADMIN' ?>">Ambulant</a>
            </li>

            <li>
              <a href="<?php echo base_url() . 'pages/view/deliveryinfoNONADMIN' ?>">Delivery</a>
            </li>

            <li>
              <a href="<?php echo base_url() . 'pages/view/parkinginfoNONADMIN' ?>">Parking</a>
            </li>
          </ul>
        </li>
