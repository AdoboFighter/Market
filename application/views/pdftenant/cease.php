...
$txt = '    This is to certify that Mr./Mrs./Ms. '.$fname.' '.$mname.' '.$lname.' BY: ' .$sysuser.' is a ' .$client.', whose nature of business is '.$natbus.', With Map# '.$stall.' at the '.$floor_level.' San Pablo City Shopping Mall & public Market has ceased operating his/her business since '.$ceasedate.'                ';
