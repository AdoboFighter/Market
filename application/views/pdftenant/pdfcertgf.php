...
$txt = '    This is to certify that Mr./Mrs./Ms.'.$fname.' '.$mname.' '.$lname.' is a TEMPORARY / AMBULANT vendor whose nature of business is '.$natbus.' with '.$stall.' at the San Pablo City Shopping Mall and Public Market.             ';
