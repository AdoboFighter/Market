  ...
  <main class="mt-5 ">
    ...
    <div class="container wow fadeIn">
      ...
      <div class=" d-flex align-items-center justify-content-center ">
        <h2 class="mr-2" id="exampleModalPreviewLabel">Tenant Payment</h5>
      ...
      <div class="row ">
        ...
        <!-- Cart -->
        <ul class="list-group mb-3 z-depth-1 w-100">
          <li class="list-group-item d-flex justify-content-between lh-condensed">

            <div class="mb-2 w-100">
              <label>O.R</label>
              <input type="text"  maxlength="7" class="w-100 form-control payment_details ntw text-danger inputmoney" name="pay[payment_or_number]" id="payment_or_number" required/>
            </div>
