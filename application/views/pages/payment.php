<div id="content">
  ...
  <div class="container justify-content-center">
          ...
          <div class="row p-3">
            <div class="col">
              <div class="form-inline">
                ...
                <input class="form-control form-control-sm mr-3 w-75" type="text" id="search_cl_f" placeholder="Search (stall#, name, section, etc)" aria-label="Search">
            ...
            <table class="table table-striped table-bordered shadow" id="tableNoStall">
              <thead>
                <tr>
                  ...
                  <td class="border border-dark">Floor</td>
                  <td class="border border-dark">Section</td>
                  <td class="border border-dark">To pay</td>
                </tr>
              </thead>
              <tbody>
              </tbody>
    ...
    <<<<<<< HEAD <div id="TenantPay" data-backdrop="static" class="modal fade right" tabindex="-1" role="dialog" aria-labelledby="exampleModalPreviewLabel" aria-hidden="true">
                          ...
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-12">
                                ...
                                >>>>>>> b8939a79764aab79cf957dcc411e98a69abd23f5
                              </div>
                            </div><br>
                                                    ...
                                                    <div class="col" id="demo">
                                                      ...
                                                      <<<<<<< HEAD </div> <!-- customer details -->
                                                        ...
                                                        <div class="col-6">
                                                          ...
                                                          <div class="mb-2">
                                                            <label>O.R</label>
                                                            <input type="text" class="form-control payment_details" name="" id="payment_or_number" required>
                                                          </div>


                                                          <<<<<<< HEAD <!-- end of row for details -->
                                                    ...
                                                    <div id="chequeDetails">
                                                      <div class="row">
                                                        <div class="col-6">
                                                          ...
                                                          <div class="col">
                                                            ...
                                                            <div class="mb-2">
                                                              ...
                                                              <input type="text" class="form-control payment_details ntw" name="amount_to_pay" id="payment_amount_to_pay" onkeypress="return isNumberKey(this, event);" ondrop="return false;" onpaste="return false;" oncontextmenu="return false;" required>
                                                            </div>
                                                        ...
                                                        <div id="chequeDetails">
                                                          ...
                                                          <<<<<<< HEAD <div class="mb-2 form-group">
                                                            <table class="table table-striped table-bordered p-2 shadow" id="table_cheque">
                                                              <thead>
                                                                <tr>
                                                                  <th class="border border-dark">Cheque no</th>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <<<<<<< HEAD <iframe src="" id="frameasdas" height="800" width="100%">
                            </iframe>
