<div id="content">
  ...
  <!-- pagecontents dito mo lagay  -->
    ...
    <div id="parkingPay" class="modal fade modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" >
        ...
        <div class="modal-content p-2">
          ...
          <!-- paymentDet ID -->
              ...
              <div class="mb-2">
                ...
                <input type="text" class="form-control" name="" id="payment_customer_id" >
              </div>
              <div class="mb-2">
                <label>Driver ID</label>
                <input type="text" class="form-control" name="" id="payment_driver_id"  >
              </div>

              <div class="mb-2">
                <label>Parking lot</label>
                <input type="text" class="form-control" name="" id="payment_parking_lot_no"  >
              </div>

              <div class="mb-2">
                <label>Name</label>
                <input type="text" class="form-control" name="" id="payment_name" >
              </div>
