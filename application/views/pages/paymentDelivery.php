		...
		<main class="mt-5 ">
			...
			<div class="container wow fadeIn">
				...
				<div class=" d-flex align-items-center justify-content-center ">
					<h2 class="mr-2" id="exampleModalPreviewLabel">Delivery Payment</h5>
				...
				<!-- Heading -->
				<!-- <h2 class="text-center">Delivery Payment</h2> -->
					...
					<div class="card p-3">
						...
						<!--Card content-->
							...
							<div class="row">
								...
								<div class="col-md-6 mb-2">
									...
									<div class="mb-2">
										...
										<input type="text" class="form-control " name="pay[stall_number]" id="plate" readonly>
									</div>
							...
							<div class="mb-2">
								...
								<input type="text" class="form-control " name="pay[customer_name]" id="companydriver" readonly>
							</div>
...
<div id="searchmodal" class="modal fade right" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalPreviewLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">Delivery search</h5>
